...
export const Hero = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-20 md:pt-40 relative overflow-hidden">
      ...
      >
        <Balancer>
          Layer-by-layer retail intelligence reveals untapped opportunities.
          From scraped network data to strategic decisions—see the market like
          never before.
        </Balancer>
      </motion.p>
      <motion.div
