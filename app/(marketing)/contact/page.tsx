...
export const metadata: Metadata = {
  title: "Contact Us - MapTheGap",
  description:
    "Get in touch with MapTheGap. We help businesses discover network coverage gaps and optimize their location strategies across multiple countries.",
  openGraph: {
