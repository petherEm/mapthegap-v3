...
async function SecurityContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-50">Security</h2>
      ...
      <div className="bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5">
        <h3 className="font-medium text-neutral-900 dark:text-neutral-50 mb-1">Password</h3>
      ...
      {/* Active Sessions */}
      <div className="bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5">
        <h3 className="font-medium text-neutral-900 dark:text-neutral-50 mb-1">Active Sessions</h3>
        <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
            <div>
              ...
              <p className="text-xs text-neutral-600 dark:text-neutral-400">Last active: Just now</p>
            </div>
        ...
        <button
          disabled
          className="mt-4 px-4 py-2 bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-lg text-sm font-medium opacity-50 cursor-not-allowed"
        >
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="h-5 w-56 bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse mt-2" />
      </div>
      <div className="bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5">
