...
async function DangerContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-neutral-50">Danger Zone</h2>
      ...
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-5">
        <h3 className="font-medium text-neutral-50 mb-1">Export Your Data</h3>
      ...
      <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-medium text-neutral-50 mb-1">Delete Account</h3>
            <p className="text-sm text-neutral-400 mb-4">
              Permanently delete your account and all associated data. This
              action cannot be undone.
            </p>
            <div className="space-y-3">
              <p className="text-sm text-red-400">This will immediately:</p>
